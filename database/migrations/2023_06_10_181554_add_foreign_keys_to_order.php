...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('order', function (Blueprint $table) {
            ...
            $table->foreign('service_id', 'fk_order_service_to_users')->references('id')->on('service')->onUpdate('CASCADE')->onDelete('CASCADE');
    ...
    {
        Schema::table('order', function (Blueprint $table) {
            $table->dropForeign('fk_order_to_users');
            $table->dropForeign('fk_order_freelancer_to_users');
            $table->dropForeign('fk_order_service_to_users');
